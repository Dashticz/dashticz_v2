        ...
        success:function(data) {
			...
			$(data).find("item").each(function () { // or "item" or whatever suits your feed
               var el = $(this);
				...
				text = text.split(') [');
				text = text[0]+')';
				$("div.traffic").replaceWith('<div class="traffic"><div class="mh col-xs-'+width+' hover transbg trafficrow" data-toggle="modal" data-target="#trafficweb" onclick="setSrc(this);"><div class="col-xs-2 col-icon"><em class="fa fa-car"></em></div><div class="col-xs-10"><strong>'+text+'</strong></div></div></div>');
